function adivinarSexo(){
    ...
    let sexo = {
    "recinto" : document.ingresada.recinto.value,
...
function mostrarCalculos(obtenidos){
    ...
    document.getElementById('tituloProbabilidades').innerHTML = 'Las probabilidades de los sexos son';

    document.getElementById('femeninoCalculada').innerHTML = obtenidos[0]['clase']+': '+ obtenidos[0]['probabilidad'];

    document.getElementById('masculinoCalculada').innerHTML = obtenidos[1]['clase']+': '+ obtenidos[1]['probabilidad'];
    ...
    document.getElementById('sexoAsignado').innerHTML = 'Es probable que su sexo sea: '+ asignado;
}